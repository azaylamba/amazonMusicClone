Hello folks, we will be designing our own music collection platform like Amazon Music. You have to design & build the backend for the application and the ability for the users to register, listen to songs, browse songs and check other information.
Your task is to go through below templates/stories and create an Amazon Music clone.
...
https://github.com/azaylamba/amazonMusicClone 
